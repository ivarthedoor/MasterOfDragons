...
from npc_and_narration import NpcCharacters
...
class InitializeGame(PlayerData):
    def __init__(self):
        ...
        self.archer = self.enemy.archer_goblin()
        self.mage = self.enemy.goblin_mage()
        self.warlord = self.enemy.goblin_warlord()
        self.first_boss = self.enemy.first_boss()
        self.second_boss = self.enemy.second_boss()
        self.third_boss = self.enemy.third_boss()
        self.fourth_boss = self.enemy.fourth_boss()
        self.fifth_boss = self.enemy.fifth_boss()
    ...
    def run_the_game(self):
        ...
        self.print_interface(self.dundalions_dialogue[1], 3)  # Dundalion appears for the first time
