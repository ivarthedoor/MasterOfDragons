...
class BodyLoot:
    def __init__(self):
        self.add_health_points_loot = 0
        self.add_damage_points_loot = 0
    ...
    def loot_method(self):
        while True:
            ...
            elif player_input == "n":  # Gracz nie chce szukać loot'u
                self.add_health_points_loot = 0
                self.add_damage_points_loot = 0  
                return False
