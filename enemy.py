...
class Enemy:
    ...
    def first_boss(self):
        ...
        self.tekst = "You dare step into the shadows where my dominion reigns?\n \
    ...
    def second_boss(self):
        ...
        self.tekst = "I am Volrathor, breaker of worlds! My power knows no bounds, and every swing of my hammer crushes hope itself.\n \
    ...
    def third_boss(self):
        ...
        self.tekst = "Ah, a brave soul lost in the labyrinth of my making. I am Eryndalys, the weaver of dreams and nightmares.\n \
    ...
    def fourth_boss(self):
        ...
        self.tekst = "Foolish mortal! You face Thalrog, heir to the draconic bloodline!\n \
    ...
    def fifth_boss(self):
        ...
        self.tekst = "Behold Narvatharna, the Iron Breaker! My armor is impenetrable, my will unyielding.\n \
